...
public class DrawCircle : MonoBehaviour
{
    ...
    [Range(0, 1000)]
    private int _segments = 1000;

    [SerializeField]
    [Tooltip("The radius of the horizontal axis.")]
    private float _horizRadius = 0.5f;

    [SerializeField]
    [Tooltip("The radius of the vertical axis.")]
    private float _vertRadius = 0.5f;
    ...
    public float _Brightness = 1000f;
    // public float _Contrast = 5f;
    ...
    void Start()
    {
        ...
        _line.material.SetColor("_Color", Color.white);

        _line.material.SetFloat ("_Brightness", _Brightness);
        // _line.material.SetFloat ("_Contrast", _Contrast);
        UpdateValuesChanged();
